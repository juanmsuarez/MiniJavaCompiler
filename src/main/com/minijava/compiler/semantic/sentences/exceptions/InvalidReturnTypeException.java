...
public class InvalidReturnTypeException extends SemanticException {
    private static final String ERROR_MESSAGE = "expresión de retorno inválida, verifique que el método no tenga tipo de retorno void y que la expresión retornada sea un subtipo";
